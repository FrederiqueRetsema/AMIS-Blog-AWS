...
# upload.py
# =========
# Will first get the upload url, the filename etc. and then upload the file to S3.
# 
...
def get_parameters():
  ...
  if (len(sys.argv) != 4):
      print ("Add API gateway URL, the API Key and the local filename as argument, f.e. python ./upload.py https://0ntricimgi.execute-api.eu-west-1.amazonaws.com/Prod/getpresignedurl 7ptnuyh526 myfile.txt")
      sys.exit(1)
