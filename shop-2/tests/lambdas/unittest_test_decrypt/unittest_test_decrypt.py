...
def get_valid_sns_event(shop_id, content_base64):
  event = {
      "Records": [ 
         { 
             "EventSource": "aws:sns", 
...
def testcase_decrypt_correct_AMIS1():
  ...
  response             = get_valid_sns_event(shop_id, content_base64)
...
def testcase_decrypt_error_no_shop_id_in_body():
  ...
  event                = {"Records": [{"Sns" : {"Message": json.dumps({"body": {"no_shop_id":"True"}})}}]}
...
def testcase_decrypt_error_no_content_base64_in_body():
  ...
  event                = {"Records": [{"Sns" : {"Message": json.dumps({"body": {"shop_id":"AMIS1", "no_content_base64" : "True"}})}}]}
